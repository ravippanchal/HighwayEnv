...
class ParkingEnv_Model1(AbstractEnv, GoalEnv):
    """
    ...
    def _create_vehicles(self) -> None:
        ...
        for vehicle in self.controlled_vehicles:
            ...
            self.road, lane.position(-lane.length/2, lane.width/2), heading=np.deg2rad(30)
        )
...
class ParkingEnv_Model1ActionRepeat(ParkingEnv_Model1):
    def __init__(self):
        super().__init__({"policy_frequency": 1, "duration": 20})


class ParkingEnv_Model1ParkedVehicles(ParkingEnv_Model1):
    def __init__(self):
